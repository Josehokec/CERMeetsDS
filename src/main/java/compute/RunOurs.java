...
public class RunOurs {
    ...
    public static List<byte[]> communicate(String sql, List<FilterBasedRPC.Client> clients,
        ...
        if(computeCacheStore != null){
            computeCacheScanThread = new ComputeCacheScanThread(computeCacheStore, ipMap, cacheThreadNum);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ComputeNodeCache computeCacheStore = ComputeNodeCache.load(datasetName, clients, Args.computeCachePageNum);
