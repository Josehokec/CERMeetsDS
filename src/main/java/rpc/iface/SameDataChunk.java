...
public class SameDataChunk implements org.apache.thrift.TBase<SameDataChunk, SameDataChunk._Fields>, java.io.Serializable, Cloneable, Comparable<SameDataChunk> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SameDataChunk");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SameDataChunkStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SameDataChunkTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SameDataChunk.class, metaDataMap);
  }

  public SameDataChunk() {
  }
   ...
   */
  public SameDataChunk(SameDataChunk other) {
  ...
  @Override
  public SameDataChunk deepCopy() {
    return new SameDataChunk(this);
  }
  ...
  public SameDataChunk setChunkId(int chunkId) {
    this.chunkId = chunkId;
    setChunkIdIsSet(true);
    return this;
  }
  ...
  public SameDataChunk setData(byte[] data) {
    this.data = data == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(data.clone());
    return this;
  }

  public SameDataChunk setData(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer data) {
    this.data = org.apache.thrift.TBaseHelper.copyBinary(data);
    return this;
  }
  ...
  public SameDataChunk setIsLastChunk(boolean isLastChunk) {
    this.isLastChunk = isLastChunk;
    setIsLastChunkIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof SameDataChunk)
      return this.equals((SameDataChunk)that);
    return false;
  }

  public boolean equals(SameDataChunk that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(SameDataChunk other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SameDataChunk(");
    boolean first = true;
  ...
  private static class SameDataChunkStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public SameDataChunkStandardScheme getScheme() {
      return new SameDataChunkStandardScheme();
    }
  }

  private static class SameDataChunkStandardScheme extends org.apache.thrift.scheme.StandardScheme<SameDataChunk> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, SameDataChunk struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, SameDataChunk struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SameDataChunkTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public SameDataChunkTupleScheme getScheme() {
      return new SameDataChunkTupleScheme();
    }
  }

  private static class SameDataChunkTupleScheme extends org.apache.thrift.scheme.TupleScheme<SameDataChunk> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SameDataChunk struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SameDataChunk struct) throws org.apache.thrift.TException {
