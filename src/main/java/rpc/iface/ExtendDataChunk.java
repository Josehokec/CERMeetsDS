...
public class ExtendDataChunk implements org.apache.thrift.TBase<ExtendDataChunk, ExtendDataChunk._Fields>, java.io.Serializable, Cloneable, Comparable<ExtendDataChunk> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ExtendDataChunk");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ExtendDataChunkStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ExtendDataChunkTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ExtendDataChunk.class, metaDataMap);
  }

  public ExtendDataChunk() {
  }
   ...
   */
  public ExtendDataChunk(ExtendDataChunk other) {
  ...
  @Override
  public ExtendDataChunk deepCopy() {
    return new ExtendDataChunk(this);
  }
  ...
  public ExtendDataChunk setChunkId(int chunkId) {
    this.chunkId = chunkId;
    setChunkIdIsSet(true);
    return this;
  }
  ...
  public ExtendDataChunk setData(byte[] data) {
    this.data = data == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(data.clone());
    return this;
  }

  public ExtendDataChunk setData(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer data) {
    this.data = org.apache.thrift.TBaseHelper.copyBinary(data);
    return this;
  }
  ...
  public ExtendDataChunk setIsLastChunk(boolean isLastChunk) {
    this.isLastChunk = isLastChunk;
    setIsLastChunkIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof ExtendDataChunk)
      return this.equals((ExtendDataChunk)that);
    return false;
  }

  public boolean equals(ExtendDataChunk that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(ExtendDataChunk other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ExtendDataChunk(");
    boolean first = true;
  ...
  private static class ExtendDataChunkStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public ExtendDataChunkStandardScheme getScheme() {
      return new ExtendDataChunkStandardScheme();
    }
  }

  private static class ExtendDataChunkStandardScheme extends org.apache.thrift.scheme.StandardScheme<ExtendDataChunk> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, ExtendDataChunk struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExtendDataChunk struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ExtendDataChunkTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public ExtendDataChunkTupleScheme getScheme() {
      return new ExtendDataChunkTupleScheme();
    }
  }

  private static class ExtendDataChunkTupleScheme extends org.apache.thrift.scheme.TupleScheme<ExtendDataChunk> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ExtendDataChunk struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ExtendDataChunk struct) throws org.apache.thrift.TException {
