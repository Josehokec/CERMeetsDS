...
public class DataChunk implements org.apache.thrift.TBase<DataChunk, DataChunk._Fields>, java.io.Serializable, Cloneable, Comparable<DataChunk> {
  ...
  public DataChunk setData(byte[] data) {
    this.data = data == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(data.clone());
    return this;
  }

  public DataChunk setData(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer data) {
    this.data = org.apache.thrift.TBaseHelper.copyBinary(data);
    return this;
  }
  ...
  public DataChunk setIsLastChunk(boolean isLastChunk) {
    this.isLastChunk = isLastChunk;
    setIsLastChunkIsSet(true);
    return this;
  }
